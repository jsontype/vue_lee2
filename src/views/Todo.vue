<template>
	<div>
		<div>
			...
			<span>
				<button class="p-1 mb-2 bg-green-500 text-slate-50 rounded" @click="addTodo">추가</button>
			</span>
		</div>
		...
		<div v-for="todo in todos" :key="todo.id">
			<span @click="toggleTodo(todo)">
				...
				<button class="m-1 p-1 bg-pink-500 text-slate-50 rounded" @click="delTodo(todo.id)">삭제</button>
			</span>
